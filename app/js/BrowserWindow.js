...
onload = function() {
    ...
    // require('electron').ipcRenderer.on('url', function(event, msg) {
    //     console.log(msg);
   ...
   // doLayout();
    ...
    document.querySelector('#back').onclick = function() {
           let  visible = document.querySelector('.etabs-views .visible');
           visible.goBack();
    };
    ...
    document.querySelector('#home').onclick = function() {
       // navigateTo('http://172.16.5.200:8333/fanzhuan/');
        ipcRenderer.send('home','Display service networking desktop');
    };
    ...
    var Maximization=document.getElementById('Maximization');
    document.getElementById("min_button").onclick = function() {

        ipcRenderer.send('b_min_button',event.channel)
    };
    let flg=true;
    document.getElementById("max_button").onclick = function() {
        ipcRenderer.send('b_max_button',event.channel);
        if (flg) {
    ...
    document.getElementById("exit_button").onclick = function() {
        ...
        ipcRenderer.send('b_exit_button',event.channel)
    };
...
function doLayout() {
    ...
    var webviewHeight = windowHeight - controlsHeight-40;
